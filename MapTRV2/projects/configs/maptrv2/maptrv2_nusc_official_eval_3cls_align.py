...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data2/wyc/nuplan_maptrv2/data/infos/nuscenes_map_infos_eval_sub_orig_path.pkl',
        map_ann_file='/data2/wyc/nuplan_maptrv2/data/infos/nuscenes_official_8sub.json',
