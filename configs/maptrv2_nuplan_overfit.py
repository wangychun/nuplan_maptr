_base_ = [
    '../MapTRV2/projects/configs/datasets/custom_nus-3d.py',
    '../MapTRV2/projects/configs/_base_/default_runtime.py'
]
#
plugin = True
plugin_dir = '../MapTRV2/projects/mmdet3d_plugin/'
...
# camera-only pipeline（参考 AV2 配置，不加载点云深度监督）
train_pipeline = [
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuplan_map_infos_overfit.pkl',
